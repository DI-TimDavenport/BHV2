      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto" id=".collapse.navbar-collapse">
              <Nav.Link as={Link} to="/team" data-toggle="collapse">
                Team
              </Nav.Link>
              ...
              <NavDropdown title="The Game" id="collapsible-nav-dropdown">
                <NavDropdown.Item as={Link} to="/lore">
                  Lore
                </NavDropdown.Item>
                ...
                <NavDropdown.Item as={Link} to="/gameplay">
                  Gameplay
                </NavDropdown.Item>
                <NavDropdown.Divider />
            ...
            <Nav>
              <Nav.Link href="https://docs.bucketheads.io/" target={"_blank"}>
                Whitepaper
              </Nav.Link>
              <Nav.Link as={Link} to="/staking">
                Staking
              </Nav.Link>
